...
CrossFadeController::CrossFadeController() : mClip(0),
mTime(0.0f), mWasSkeletonSet(false) {}

CrossFadeController::CrossFadeController(Skeleton&
	skeleton) : mClip(0),
	mTime(0.0f) 
{
...
void CrossFadeController::FadeTo(FastClip* target,
	float fadeTime) 
{
	if (mClip == 0) 
	{
